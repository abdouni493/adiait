...
export const TABLES: Record<CollectionKey, TableSpec> = {
  ...
  semesters: { table: "semesters", pk: "id", columns: ["id", "name", "start_date", "end_date", "planned_end_date", "description", "closed_at", "extension_seen_at", "created_at", "created_by", "created_by_name", "created_by_role"] },
  sessions: { table: "schedule_sessions", pk: "id", columns: ["id", "semester_id", "class_id", "module_id", "group_id", "salle_id", "teacher_id", "days", "start_time", "end_time", "day_times", "day_slots", "day_salles", "class_groups", "is_open", "title", "period_start", "period_end", "class_ids", "group_ids", "salle_ids", "open_price", "archived_at", "created_by", "created_by_name", "created_by_role"], emptyAsNull: ["semester_id", "class_id", "module_id", "group_id", "salle_id", "teacher_id"] },
  emploiCartes: { table: "emploi_cartes", pk: "id", columns: ["id", "semester_id", "session_id", "index", "code", "size", "planned_start_date", "start_date", "end_date", "held", "postponed", "status", "created_at", "created_by", "created_by_name", "created_by_role"], emptyAsNull: ["semester_id", "session_id"] },
  ...
  cash: { table: "cash_transactions", pk: "id", columns: ["id", "type", "amount", "date", "description", "category_id", "caisse", "created_by", "created_by_name", "created_by_role"], emptyAsNull: ["category_id"] },
  ...
  // — L'ÉCURIE. Les chevaux d'abord : tout le reste s'y réfère. —
  horses: { table: "horses", pk: "id", columns: ["id", "name", "reference", "breed", "gender", "birth_date", "age", "color", "height", "weight", "vaccination", "medical_history", "vet_exam", "discipline", "training_level", "competition_history", "awards", "sire", "dam", "pedigree_docs", "purchase_price", "seller_name", "seller_phone", "seller_note", "purchase_date", "selling_price", "status", "origin", "owner_kind", "owner_student_id", "owner_parent_id", "owner_name", "owner_phone", "owner_note", "created_at", "created_by", "created_by_name", "created_by_role"], emptyAsNull: ["owner_student_id", "owner_parent_id", "gender"] },
  horseSales: { table: "horse_sales", pk: "id", columns: ["id", "horse_id", "horse_name", "buyer_kind", "buyer_student_id", "buyer_parent_id", "buyer_name", "buyer_phone", "buyer_note", "date", "base_price", "discount_type", "discount_value", "total", "paid", "rest", "status", "cash_id", "description", "created_at", "created_by", "created_by_name", "created_by_role"], emptyAsNull: ["horse_id", "buyer_student_id", "buyer_parent_id", "cash_id", "discount_type"] },
  horseSalePayments: { table: "horse_sale_payments", pk: "id", columns: ["id", "sale_id", "amount", "date", "description", "cash_id", "created_at", "created_by", "created_by_name", "created_by_role"], emptyAsNull: ["sale_id", "cash_id"] },
  horseExpenseCategories: { table: "horse_expense_categories", pk: "id", columns: ["id", "name", "created_at", "created_by", "created_by_name", "created_by_role"] },
  horseExpenses: { table: "horse_expenses", pk: "id", columns: ["id", "horse_id", "category_id", "category_name", "amount", "date", "description", "owner_debt", "cash_id", "created_at", "created_by", "created_by_name", "created_by_role"], emptyAsNull: ["horse_id", "category_id", "cash_id"] },
  horseOwnerPayments: { table: "horse_owner_payments", pk: "id", columns: ["id", "horse_id", "amount", "date", "description", "cash_id", "created_at", "created_by", "created_by_name", "created_by_role"], emptyAsNull: ["horse_id", "cash_id"] },

  // — LES AUTRES DETTES —
  otherDebts: { table: "other_debts", pk: "id", columns: ["id", "student_id", "parent_id", "person_name", "phone", "note", "amount", "description", "date", "created_at", "created_by", "created_by_name", "created_by_role"], emptyAsNull: ["student_id", "parent_id"] },
  otherDebtPayments: { table: "other_debt_payments", pk: "id", columns: ["id", "debt_id", "amount", "date", "description", "cash_id", "created_at", "created_by", "created_by_name", "created_by_role"], emptyAsNull: ["debt_id", "cash_id"] },
};
