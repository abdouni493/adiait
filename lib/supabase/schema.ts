...
export const TABLES: Record<CollectionKey, TableSpec> = {
  ...
  sessions: { table: "schedule_sessions", pk: "id", columns: ["id", "class_id", "module_id", "group_id", "salle_id", "teacher_id", "days", "start_time", "end_time", "day_times", "day_salles", "class_groups", "is_open", "title", "period_start", "period_end", "class_ids", "group_ids", "salle_ids", "open_price", "archived_at", "created_by", "created_by_name", "created_by_role"], emptyAsNull: ["class_id", "module_id", "group_id", "salle_id", "teacher_id"] },
  subscriptions: { table: "subscriptions", pk: "id", columns: ["id", "session_id", "price_per_session", "level_price", "period_months", "monthly_seances", "monthly_price", "school_month_share", "teacher_per_seance", "engagement_fee", "engagement_description", "archived_at", "created_by", "created_by_name", "created_by_role"], emptyAsNull: ["session_id"] },
  ...
  attendance: { table: "attendance_records", pk: "id", columns: ["id", "student_id", "session_id", "timestamp", "amount_deducted", "status", "substitute_group", "free_period_id", "pre_start", "waived_amount", "no_charge", "created_by", "created_by_name", "created_by_role"], emptyAsNull: ["student_id", "session_id", "free_period_id"] },
  ...
  unpaidTeacher: { table: "unpaid_teacher_sessions", pk: "id", columns: ["id", "teacher_id", "session_id", "student_id", "amount", "date", "paid", "payment_id", "created_by", "created_by_name", "created_by_role"], emptyAsNull: ["teacher_id", "session_id", "student_id", "payment_id"] },
