 ...
 * applied. The scan, the manual présence and the weekly-absence billing all go
 * through this one function, so a price advertised on screen is always the price
 * actually charged. Never returns a negative price.
 */
