...
const LABELS = {
  fr: {
    docTitle: "Bon de Paiement Entraîneur",
    ...
    totalPresents: "Total des chevaliers présents :",
    totalRevenue: "Total généré par les séances :",
    rate: "Taux appliqué :",
    monthlySalary: "Salaire par carte contractuel :",
    net: "TOTAL À PAYER À L'ENTRAÎNEUR :",
