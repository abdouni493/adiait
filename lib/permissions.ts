...
export const PERMISSION_PAGES: PermissionPage[] = [
  ...
  },
  {
    ...
    actions: [
      ...
      {
        id: "totals",
        label: "Voir l'argent encaissé",
        hint: "SANS ce droit, les cartes de semestre, de catégorie et d'emploi du temps n'affichent QUE les dettes — jamais le total encaissé. Le détail chevalier par chevalier, lui, reste lisible dans la liste d'un emploi du temps.",
      },
      {
        id: "whatsapp",
        label: "Envoyer un message WhatsApp",
        hint: "Depuis la liste des chevaliers d'un emploi du temps : relance individuelle ou envoi groupé aux endettés.",
      },
    ],
  },
  {
  ...
  },
  {
    key: "horses",
    emoji: "🐎",
    label: "Achat & vente des chevaux",
    href: "/horses",
    hint: "Ce que le club achète, ce qu'il revend, et les ventes à crédit qui restent dues.",
    actions: [
      { id: "create", label: "Enregistrer un achat", hint: "Le prix d'achat sort de la caisse." },
      { id: "view", label: "Voir le détail d'un cheval" },
      { id: "edit", label: "Modifier une fiche de cheval" },
      { id: "delete", label: "Supprimer un cheval" },
      { id: "sell", label: "Vendre un cheval", hint: "Au comptant ou à crédit, avec remise." },
      { id: "pay", label: "Encaisser une vente à crédit" },
      { id: "print", label: "Imprimer un bon de vente ou un reçu" },
    ],
  },
  {
    key: "stable",
    ...
    label: "L'écurie",
    href: "/stable",
    hint: "Les chevaux présents — ceux du club et ceux en pension — leur suivi et leurs dépenses.",
    actions: [
      { id: "create", label: "Ajouter un cheval sans achat" },
      { id: "view", label: "Voir le détail et le suivi d'un cheval" },
      { id: "edit", label: "Modifier une fiche de cheval" },
      { id: "delete", label: "Supprimer un cheval" },
      {
        id: "expense",
        label: "Porter une dépense sur un cheval",
        hint: "Cheval du club : sortie de caisse. Cheval en pension : dette du propriétaire.",
      },
      { id: "pay", label: "Encaisser un propriétaire" },
      { id: "print", label: "Imprimer un relevé ou un reçu" },
    ],
  },
  {
    key: "stable-reports",
    emoji: "📋",
    label: "Gestion de l'écurie",
    href: "/stable-reports",
    hint: "Le bilan des dépenses et des règlements sur une période, propriétaire par propriétaire. Cet écran se consulte ; il n'écrit rien.",
    actions: [{ id: "print", label: "Imprimer le rapport" }],
  },
  {
    key: "announcements",
    emoji: "📢",
  ...
  },
  {
    ...
    label: "Autres dettes",
    href: "/other-debts",
    hint: "Ce que l'on doit au club en dehors des cotisations : un fournisseur avancé, une casse à rembourser, du matériel non rendu.",
    actions: [
      { id: "create", label: "Créer une dette" },
      { id: "view", label: "Voir le détail et l'historique" },
      { id: "edit", label: "Modifier une dette" },
      { id: "delete", label: "Supprimer une dette" },
      { id: "pay", label: "Encaisser un règlement" },
      { id: "print", label: "Imprimer un relevé ou un reçu" },
    ],
  },
  {
  ...
  },
  {
    key: "cash-secondary",
    emoji: "🪙",
    label: "Caisse secondaire",
    href: "/cash-secondary",
    hint: "La caisse des travailleurs : elle n'affiche QUE ses propres mouvements. L'argent, lui, rejoint la même trésorerie.",
    actions: [
      { id: "deposit", label: "Dépôt en caisse secondaire" },
      { id: "withdraw", label: "Retrait de la caisse secondaire" },
  ...
  },
  {
    ...
    label: "Site web",
    href: "/website",
    hint: "La vitrine du club : les formations et les évènements publiés, les coordonnées et l'habillage de la page d'accueil.",
    actions: [
      { id: "create", label: "Publier une formation ou un évènement" },
      { id: "view", label: "Voir le détail d'une formation" },
      { id: "edit", label: "Modifier une formation" },
      { id: "delete", label: "Supprimer une formation" },
      { id: "hide", label: "Retirer une formation du site", hint: "Elle disparaît de la vitrine sans être supprimée." },
      { id: "contacts", label: "Coordonnées & réseaux sociaux" },
      { id: "appearance", label: "Habillage du site", hint: "Favicon, présentations, image de fond et vidéo d'accueil." },
    ],
  },
  {
    key: "website-inscriptions",
    emoji: "📥",
    label: "Inscriptions du site",
    href: "/website-inscriptions",
    hint: "Les inscriptions venues du site public, en attente d'être vérifiées et rattachées à une fiche.",
    actions: [
      { id: "view", label: "Ouvrir une inscription" },
      { id: "verify", label: "Vérifier & accepter une inscription", hint: "Rattacher le compte à une fiche, ou la créer depuis la demande." },
      { id: "edit", label: "Corriger une inscription" },
      { id: "delete", label: "Supprimer une inscription" },
    ],
  },
  {
    key: "settings",
