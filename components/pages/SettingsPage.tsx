...
export function SettingsPage() {
  ...
  // `school` loads asynchronously (read once the session resolves), so
  ...
  // Admin Account Form State (name + password; the login email is shown
  // read-only here — it is changed from the fiche of the person concerned)
