/**
 * Test fixture — a small, self-consistent `Database` used by the unit tests
 * only. It is deliberately kept apart from the demo data the application ships
 * (`lib/demo/`): a test needs a handful of rows it can reason about line by
 * line, not a whole school.
 *
